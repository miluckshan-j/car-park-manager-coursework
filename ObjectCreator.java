    ...
    public Vehicle createVehicle(VehicleType type) {
        ...
        switch (type) {
            ...
            case Lorry:
                ...
                obj = new Lorry(plateID, brand, model, entryTime, lorryCargoCapacity, lorryHeight);
                break;
            case MiniLorry:
                System.out.println("Enter the Cargo Capacity : ");
                ...
                obj =new MiniLorry(plateID, brand, model, entryTime, miniLorryCargoCapacity, miniLorryHeight);
                break;
            case Bus:
                System.out.println("Enter the number of seats : ");
                ...
                obj = new Bus(plateID, brand, model, entryTime, busSeats, busHeight);
                break;
            case MiniBus:
                System.out.println("Enter the number of seats : ");
                ...
                obj = new MiniBus(plateID, brand, model, entryTime, miniBusSeats, miniBusHeight);
                break;
            default:
